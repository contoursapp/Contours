...
/** 
 * DAO for table "SURVEY_RESPONSE".
*/
public class SurveyResponseDao extends AbstractDao<SurveyResponse, Long> {

    public static final String TABLENAME = "SURVEY_RESPONSE";

    /**
     * Properties of entity SurveyResponse.<br/>
    ...
    */
    ...
    public SurveyResponseDao(DaoConfig config) {
        super(config);
    }
    
    public SurveyResponseDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SURVEY_RESPONSE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SURVEY_RESPONSE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SurveyResponse entity) {
        stmt.clearBindings();
        ...
        Integer response = entity.getResponse();
        if (response != null) {
            stmt.bindLong(3, response);
        }
    ...
    /** @inheritdoc */
    @Override
    public SurveyResponse readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SurveyResponse entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(SurveyResponse entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(SurveyResponse entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
